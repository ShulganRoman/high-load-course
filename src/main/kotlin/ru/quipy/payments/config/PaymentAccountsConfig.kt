...
class PaymentAccountsConfig {
    ...
    @Bean
    fun accountAdapters(paymentService: EventSourcingService<UUID, PaymentAggregate, PaymentAggregateState>, meter: MeterRegistry): List<PaymentExternalSystemAdapter> {
